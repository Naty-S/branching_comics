...
describe("Common branching_comics flow", () => {
  ...
  it("No creator user fails to publish a comic", async () => {
  });
  it("No creator user fails to unpublish a comic", async () => {
  });
  ...
  it("Creator user fails to creates a chapter of unpublished comic", async () => {
    
  });
  it("No creator user fails to creates a chapter of published comic", async () => {
    
  });
  it("User fails to list an unowned chapter for sale", async () => {
  ...
  it("Creator user fails to create choices of NO end of story branch/path", async () => {

  });
  it("No creator user fails to create choices of end of story branch/path", async () => {
